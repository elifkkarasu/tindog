...
class PetView1 extends StatefulWidget {
  const PetView1({super.key});

  @override
  State<PetView1> createState() => _PetView1State();
}

class _PetView1State extends State<PetView1> {
  @override
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Image.asset('assets/images/pugdog.jpg'),
                  ),
                  const SizedBox(
                    height: 20,
                  ),
